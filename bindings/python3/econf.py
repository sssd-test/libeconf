...
def new_key_file(delim, comment) -> EconfFile:
    """
...
def new_key_file_with_options(options) -> EconfFile:
    """
...
def set_comment_tag(ef: EconfFile, comment) -> None:
    """
...
def set_delimiter_tag(ef: EconfFile, delimiter) -> None:
    """
...
def set_string_value(ef: EconfFile, group: str, key: str, value) -> None:
    """
